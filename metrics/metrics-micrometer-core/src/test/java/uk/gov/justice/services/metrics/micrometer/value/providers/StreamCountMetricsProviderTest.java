package uk.gov.justice.services.metrics.micrometer.value.providers;
...
import uk.gov.justice.services.metrics.micrometer.meters.gauges.StreamCountRepository;
...
public class StreamCountMetricsProviderTest {
    ...
    public void shouldCountTheNumberOfStreamsInStreamStatusTable() throws Exception {
        ...
        assertThat(streamCountRepository.countStreams(), is(numberOfStreams));
    ...
    public void shouldReturnZeroStreamsIfNoResultsReturned() throws Exception {
        ...
        assertThat(streamCountRepository.countStreams(), is(zeroStreams));
    ...
    public void shouldThrowMetricsProviderExceptionIfQueryingTableFails() throws Exception {
        ...
        final MetricsProviderException metricsProviderException = assertThrows(
                ...
                () -> streamCountRepository.countStreams());
